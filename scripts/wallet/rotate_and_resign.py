...
def process_batch_file(batch_file: Path, mgr: WalletManager, dry_run: bool = False, backup: bool = False, extension: str = "json") -> int:
    count = 0
    for line in batch_file.read_text(encoding="utf-8").splitlines():
        ...
        resign_pattern = item.get("resign_pattern", extension)
