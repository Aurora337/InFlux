...
def run_pipeline(
    ...
    steps = [
        ...
        ("release_attestation", ["/usr/bin/python3", "scripts/testnet/generate_sync_ops_release_attestation.py"]),
        (
            "release_attestation_validation",
            ["/usr/bin/python3", "scripts/testnet/validate_sync_ops_release_attestation.py"],
        ),
    ]
