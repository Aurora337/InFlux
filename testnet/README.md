...
v1.0.9 runtime workflow:
- launch/sync_ops_release_attestation.json and launch/sync_ops_release_attestation.md capture deterministic release attestation status, fingerprint, and required sign-off contract from reproducibility artifacts
- launch/sync_ops_release_attestation_validation.json and launch/sync_ops_release_attestation_validation.md capture deterministic release attestation integrity and cross-artifact consistency validation

v1.1.0 runtime workflow:
- launch/sync_ops_release_attestation_validation_pipeline.json and launch/sync_ops_release_attestation_validation_pipeline.md capture one-command deterministic reproducibility plus release-attestation generation/validation execution with stage outcomes and artifact hashes

v1.1.1 runtime workflow:
- launch/sync_ops_release_attestation_validation_pipeline_validation.json and launch/sync_ops_release_attestation_validation_pipeline_validation.md capture deterministic integrity and cross-artifact consistency checks for release-attestation validation pipeline outputs
